...
CATALOGUE: list[dict[str, Any]] = [
    ...
    {"product": "book-beyond-matrix-1",
     ...
     "description": {"summary": {"en": "Digital book — adult readers. PDF + EPUB delivery Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "book-language-of-angels",
     ...
     "description": {"summary": {"en": "Digital book. PDF + EPUB delivery Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "book-angels-story",
     ...
     "description": {"summary": {"en": "Children's digital book Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "course-language-forgot",
     ...
     "description": {"summary": {"en": "Audio + written course. Self-paced Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 25.00, "EUR": 23.00}},
     "format": "digital"},
    {"product": "course-seven-evenings",
     "display": {"en": "Seven Quiet Evenings with Children"},
     "description": {"summary": {"en": "Audio + written course for parents. Self-paced Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "voice-topup-30",
     ...
     "description": {"summary": {"en": "30 minutes of voice-companion time across any of the five rooms. Unused minutes refundable within 14 days Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 22.00, "EUR": 20.00}},
     "format": "digital"},
    {"product": "voice-topup-60",
     "display": {"en": "Voice Companion · 60 minutes"},
     "description": {"summary": {"en": "60 minutes of voice-companion time across any room Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 46.00, "EUR": 42.00}},
     "format": "digital"},
    {"product": "voice-topup-180",
     "display": {"en": "Voice Companion · 3 hours"},
     "description": {"summary": {"en": "180 minutes of voice-companion time across any room Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "voice-topup-premium-30",
     ...
     "description": {"summary": {"en": "Premium tier: hybrid TTS + priority access. 30 minutes voice time Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 31.00, "EUR": 29.00}},
     "format": "digital"},
    {"product": "voice-topup-premium-60",
     "display": {"en": "Voice Companion Premium · 60 minutes"},
     "description": {"summary": {"en": "Premium tier: hybrid TTS + priority access. 60 minutes voice time Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 64.00, "EUR": 59.00}},
     "format": "digital"},
    {"product": "voice-topup-premium-180",
     "display": {"en": "Voice Companion Premium · 3 hours"},
     "description": {"summary": {"en": "Premium tier: hybrid TTS + priority access. 180 minutes voice time Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "clarity-30min",
     ...
     "description": {"summary": {"en": "30-minute voice + text Clarity Release session Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 22.00, "EUR": 20.50}},
     "format": "digital"},
    {"product": "clarity-60min",
     "display": {"en": "Clarity Release · 60 minutes"},
     "description": {"summary": {"en": "60-minute voice + text Clarity Release session Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 39.00, "EUR": 36.00}},
     "format": "digital"},
    ...
    {"product": "sub-text-basic",
     ...
     "description": {"summary": {"en": "Unlimited text mode, fair use ~200 conversations/month. Cancel anytime. Recurring monthly Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 42.00, "EUR": 39.00}, "interval": "month"},
     "format": "digital",
     "_kind": "subscription"},
    {"product": "sub-text-voice-15",
     "display": {"en": "Text + 15 min Voice (Monthly)"},
     "description": {"summary": {"en": "Unlimited text (fair use ~200/mo) + 15 voice minutes. Monthly. Cancel anytime Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 75.00, "EUR": 69.00}, "interval": "month"},
     "format": "digital",
     "_kind": "subscription"},
    {"product": "sub-text-premium",
     "display": {"en": "Text Premium (Monthly)"},
     "description": {"summary": {"en": "Unlimited text (fair use ~250/mo) + 30 voice minutes. Monthly Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 108.00, "EUR": 99.00}, "interval": "month"},
     "format": "digital",
     "_kind": "subscription"},
    {"product": "sub-steady-monthly",
     "display": {"en": "Steady Monthly"},
     "description": {"summary": {"en": "60 min voice/mo + weekly letter + library access. Monthly recurring Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 130.00, "EUR": 120.00}, "interval": "month"},
     "format": "digital",
     "_kind": "subscription"},
    {"product": "sub-own-room-monthly",
     "display": {"en": "Own Room Monthly"},
     "description": {"summary": {"en": "4 h voice/mo + premium room access (Grace/Kaelan/Sara/Alistair) + unlimited Aurin. Monthly recurring Not therapy. Not medical advice. Educational content."}},
    ...
    {"product": "tier-voyager",
     ...
     "description": {"summary": {"en": "7-day memory + Course-room first chapter preview. Monthly Not therapy. Not medical advice. Educational content."}},
     "pricing": {"price": {"USD": 9.00, "EUR": 8.50}, "interval": "month"},
     "format": "digital",
     "_kind": "subscription"},
    {"product": "tier-eternal",
     "display": {"en": "Eternal Membership"},
     "description": {"summary": {"en": "Full hybrid memory + insights export + priority access. Monthly Not therapy. Not medical advice. Educational content."}},
