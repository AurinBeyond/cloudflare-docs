...
WEEK_4_PRESENCE = [
    ...
    {"day": 26, "week_key": "presence", "week_number": 4, "title": "The inner sanctuary",
     "body": "When the outer world is loud, the body holds an inner sanctuary. Today we visit it.",
     "practice": ["Close your eyes.",
                  "Imagine a small room inside your chest.",
                  "Walk into it. Describe it to yourself.",
                  "Stay there for five minutes."],
     "duration_min": 7, "reflection": "What does my inner sanctuary look like?", "is_premium": True},
