/**
 * AlistairIntro.jsx — Host introduction page for the Sara Forest room.
 *
...
const OFFERINGS = [
  {
    ...
    line: "Notice where you actually want to go.",
  },
  {
    icon: Map,
    title: "Draw the question",
    line: "Make the unclear thing visible.",
  },
  {
    icon: BookMarked,
    title: "Open a small experiment",
    line: "Try one thing before deciding the whole.",
  },
  {
    icon: Lightbulb,
    title: "See what you already know",
    line: "Most answers are already inside you.",
  },
  {
    icon: Key,
    title: "Choose with less fear",
    line: "Move without rushing.",
  },
];
...
export default function AlistairIntro() {
  return (
    <div
      data-testid="alistair-intro-page"
      style={{
    ...
    >
      ...
      >
        ...
        <div className="relative" data-testid="alistair-intro-painting-wrapper">
          <div
          ...
          >
            <img
              ...
              draggable={false}
              loading="eager"
              data-testid="alistair-intro-painting"
        ...
        <div
          ...
          data-testid="alistair-intro-panel"
        >
          <div
            aria-hidden="true"
          ...
          <div className="lg:px-8">
            <div
              ...
              data-testid="alistair-intro-eyebrow"
            >
              Keeper of the map
            </div>
            ...
            <h1
              ...
              data-testid="alistair-intro-name"
            >
              Sara
            </h1>
            ...
            <p
              ...
              data-testid="alistair-intro-greeting"
            >
            ...
            <p
              ...
              data-testid="alistair-intro-body"
            >
              I keep a quiet laboratory where decisions are mapped before they are made. I do not push you toward an answer. I sit with you while you draw the question more carefully.
            </p>
            ...
            >
              ...
              <span
                ...
                data-testid="alistair-intro-offerings-heading"
              >
                Here, you may
              </span>
              <span style={{ height: 1, width: 36, background: RULE, opacity: 0.6 }} />
            ...
            <ul
              ...
              data-testid="alistair-intro-offerings"
            >
              {OFFERINGS.map(({ icon: Icon, title, line }, i) => (
                <li
                  key={title}
                  className="flex items-start gap-4"
                  data-testid={`alistair-intro-offering-${i + 1}`}
                >
                  <Icon
                    size={26}
                    strokeWidth={1.5}
            ...
            <p
              ...
              data-testid="alistair-intro-closing-line"
            >
              Take what you need. Leave what does not fit.
              <br />
              The lab will be here when you return.
            </p>

            <div className="flex justify-center mt-8">
              <Link
                to="/alistair"
                data-testid="alistair-intro-enter-button"
              ...
              >
                Enter Alistair&rsquo;s laboratory
              </Link>
            </div>
            ...
            >
              ...
              <span
                ...
                data-testid="alistair-intro-signature"
              >
                Alistair
              </span>
              <span style={{ height: 1, width: 70, background: RULE, opacity: 0.5 }} />
